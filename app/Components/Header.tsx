...
const Header = () => {
    ...
    return (
        <header className="w-full">
            ...
            <div 
                className={`${nav ? 'opacity-100' : 'opacity-0'} transition-opacity duration-500 absolute top-0 left-0 w-screen min-h-screen flex items-center justify-center bg-pink-700 z-10`}
                onClick={() => setNav(!nav)}
            >
                <Nav />
            </div>
